...
module.exports = {
    ...
    ALL: process.env.ALL_CAPTION === undefined ? 'Made By Java' : process.env.ALL_CAPTION,
    MENTION: process.env.TAG_REPLY === undefined ? '919526941079@s.whatsapp.net' : process.env.TAG_REPLY,
    ...
    BOT: process.env.BOT_NAME === undefined ? '⊢‒‒‒ ⋈ HELLBOT ⋈ ‒‒‒⊣' : process.env.BOT_NAME,
    ...
    YAK: process.env.YAK === undefined ? '919526941079,0' : process.env.YAK,
    BRANCH: 'master',
    HEROKU: {
